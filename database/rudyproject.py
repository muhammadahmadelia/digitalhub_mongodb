...
class Rudyproject_Mongodb:
    ...
    def controller(self, store: Store) -> None:
        try:
            ...
            if self.DEBUG: print(f'Exception in Rudyproject_Mongodb: controller: {e}')
            self.print_logs(f'Exception in Rudyproject_Mongodb: controller: {e}')
    ...
    def get_matched_variant(self, scraped_variant: Variant, db_variants: list[Variant]) -> Variant:
        ...
        try:
            ...
            for index, db_variant in enumerate(db_variants):
                if scraped_variant.sku == db_variant.sku:
                    matched_index = index
                    break
